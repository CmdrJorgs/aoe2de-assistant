# Cells: `audit/05_win_probability_matchup_features.py`

## Cell 0: `# %% [markdown]`

# Audit — 05_win_probability_matchup_features: Win Probability with Civ Interactions & Eco Kills
#
...
1 01a04acd-75a6-75cd-9e0f-bcae3f37e8aa        0.25.0   

                                                           creation-date  \
  id                                                                       
0 01a04a1a-d164-7814-9629-42a89354fd95  2026-08-28T20:41:06.661197+00:00   
1 01a04acd-75a6-75cd-9e0f-bcae3f37e8aa  2026-08-28T23:56:14.119348+00:00   

                                             report_type  \
  id                                                       
0 01a04a1a-d164-7814-9629-42a89354fd95  cross-validation   
1 01a04acd-75a6-75cd-9e0f-bcae3f37e8aa  cross-validation   

                                                                                           git_commit  \
  id                                                                                                    
0 01a04a1a-d164-7814-9629-42a89354fd95  c634cf0c2227ad20d5fe3c096678d78d69378355 (working tree dirty)   
1 01a04acd-75a6-75cd-9e0f-bcae3f37e8aa  c634cf0c2227ad20d5fe3c096678d78d69378355 (working tree dirty)   

                                                                   report_id  \
  id                                                                           
0 01a04a1a-d164-7814-9629-42a89354fd95  01a04a1a-d164-7814-9629-42a89354fd95   
1 01a04acd-75a6-75cd-9e0f-bcae3f37e8aa  01a04acd-75a6-75cd-9e0f-bcae3f37e8aa   

                                                      ml_task  \
  id                                                            
0 01a04a1a-d164-7814-9629-42a89354fd95  binary-classification   
1 01a04acd-75a6-75cd-9e0f-bcae3f37e8aa  binary-classification   

                                                                                                                                              learner  \
  id                                                                                                                                                    
0 01a04a1a-d164-7814-9629-42a89354fd95  RandomForestClassifier(max_depth=10, min_samples_split=5, n_jobs=-1,\n                       random_state=42)   
1 01a04acd-75a6-75cd-9e0f-bcae3f37e8aa  RandomForestClassifier(max_depth=10, min_samples_split=5, n_jobs=-1,\n                       random_state=42)   

                                                                       name  \
  id                                                                          
0 01a04a1a-d164-7814-9629-42a89354fd95                   02_win_probability   
1 01a04acd-75a6-75cd-9e0f-bcae3f37e8aa  05_win_probability_matchup_features   
...
1 01a04acd-75a6-75cd-9e0f-bcae3f37e8aa  /home/djorgs/Documents/git/aoe2-coach/reports/projects/aoe2_win_probability/reports/2026-08-28T23-56-14.119348+00-00__id_01a04acd-75a6-75cd-9e0f-bcae3f37e8aa__cross-validation__05_win_probability_matchup_features   

                                                                   date  \
  id                                                                      
0 01a04a1a-d164-7814-9629-42a89354fd95 2026-08-28 20:41:06.661197+00:00   
1 01a04acd-75a6-75cd-9e0f-bcae3f37e8aa 2026-08-28 23:56:14.119348+00:00   
...
1 01a04acd-75a6-75cd-9e0f-bcae3f37e8aa  d55f4238f3585d100858bdf564cfcb96   

                                        accuracy  brier_score  fit_time  \
  id                                                                      
0 01a04a1a-d164-7814-9629-42a89354fd95  0.681022     0.211675  0.076749   
1 01a04acd-75a6-75cd-9e0f-bcae3f37e8aa  0.974016     0.017987  0.082235   

                                        log_loss  precision  predict_time  \
  id                                                                        
0 01a04a1a-d164-7814-9629-42a89354fd95  0.613851   0.663736      0.013617   
1 01a04acd-75a6-75cd-9e0f-bcae3f37e8aa  0.065203   0.765242      0.013971   

                                          recall   roc_auc  
  id                                                        
0 01a04a1a-d164-7814-9629-42a89354fd95  0.609753  0.664599  
1 01a04acd-75a6-75cd-9e0f-bcae3f37e8aa  0.592078  0.978439  
```
...
REPORT_ID = df_summary.loc[df_summary["name"] == "05_win_probability_matchup_features", "report_id"].iloc[0]
...
CrossValidationReport:
        'RandomForestClassifier'
                                    ...
                                    mean       std
Metric           Label                    
Accuracy                0.974016  0.015048
Precision        0      0.555556  0.509175
                 1      0.974929  0.015286
Recall           0      0.185185  0.169725
                 1      0.998971  0.001782
ROC AUC                 0.978439  0.021049
Log loss                0.065203  0.024937
Brier score             0.017987  0.008505
Fit time (s)            0.082235  0.003509
Predict time (s)        0.013971  0.000471
...
1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   NaN   
2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   NaN   
3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Class [1] represents more than 80% of the dataset samples. Accuracy should not be used alone to assess model performance as it may be misleading by ignoring poor performance on the underrepresented class.   
...
6                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     High-cardinality features detected: Feature 0, Feature 4, Feature 5 (and 9 more). Mean Decrease in Impurity (MDI) importance is biased toward such features. Consider using permutation importance for a more robust alternative.   
7                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               6 pair(s) of features have a Spearman correlation above 0.9. Highly correlated features can destabilize linear model coefficients and feature-importance estimates, and may cause collinearity-induced numerical issues.Dropping redundant features may also improve model performance.   
8                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         Your model is on par with or better than a HistGradientBoosting baseline. Baseline performance on the test set, for reference: Accuracy=0.978, Brier score=0.0196, Log loss=0.0995, Precision (0)=0.8, Precision (1)=0.983, ROC AUC=0.976, Recall (0)=0.42, Recall (1)=0.995.   
9                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   NaN   
10                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            A model trained on feature(s) ['Feature 33', 'Feature 60', 'Feature 74'] alone has similar performance to a model trained on all the features, on the default predictive metrics. This may signal data leakage or excessive reliance on a single feature.   
11  Feature(s) ['Feature #0', 'Feature #1', 'Feature #10', 'Feature #11', 'Feature #12', 'Feature #13', 'Feature #14', 'Feature #15', 'Feature #16', 'Feature #17', 'Feature #18', 'Feature #19', 'Feature #2', 'Feature #20', 'Feature #21', 'Feature #22', 'Feature #23', 'Feature #24', 'Feature #25', 'Feature #26', 'Feature #27', 'Feature #28', 'Feature #29', 'Feature #3', 'Feature #30', 'Feature #31', 'Feature #32', 'Feature #33', 'Feature #34', 'Feature #35', 'Feature #36', 'Feature #37', 'Feature #38', 'Feature #39', 'Feature #4', 'Feature #40', 'Feature #41', 'Feature #42', 'Feature #43', 'Feature #44', 'Feature #45', 'Feature #46', 'Feature #47', 'Feature #48', 'Feature #49', 'Feature #5', 'Feature #50', 'Feature #51', 'Feature #52', 'Feature #53', 'Feature #54', 'Feature #55', 'Feature #56', 'Feature #57', 'Feature #58', 'Feature #59', 'Feature #6', 'Feature #60', 'Feature #61', 'Feature #62', 'Feature #63', 'Feature #64', 'Feature #65', 'Feature #66', 'Feature #67', 'Feature #68', 'Feature #69', 'Feature #7', 'Feature #70', 'Feature #71', 'Feature #72', 'Feature #74', 'Feature #75', 'Feature #8', 'Feature #9'] have permutation importance overlapping with zero and could likely be dropped without degrading performance. Dropping redundant features may also improve model performance.   
...
accuracy                         0.974016                    0.015048
precision_0                      0.555556                    0.509175
precision_1                      0.974929                    0.015286
recall_0                         0.185185                    0.169725
recall_1                         0.998971                    0.001782
roc_auc                          0.978439                    0.021049
log_loss                         0.065203                    0.024937
brier_score                      0.017987                    0.008505
fit_time                         0.082235                    0.003509
predict_time                     0.013971                    0.000471
```
